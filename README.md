...
CSV company list -> website scan -> public contact extraction -> scoring -> reviewable English drafts -> Excel/JSON/TXT/EML export.

Works with Codex, OpenClaw, Claude Code, Windows, macOS, and Linux through the same CLI.

## Safety

No automatic sending, LinkedIn automation, captcha/login/paywall/rate-limit bypass, proxy pools, forged fingerprints, SMTP probing, or guessed-email sending. Every conclusion keeps evidence text and a source URL.
